...
// (весь код из вашего script.js остается без изменений)
const functions = {
    sphere: {
        name: 'Сфера',
        f: (x, y) => x*x + y*y,
...
class QuadraticProgrammingSolver {
    ...
    solveAuxiliaryProblem() { // Убрана точка с запятой
        this.iterations = [];
...
function visualizeQP(x1Opt = null, x2Opt = null) {
    ...
    const layout = {
        title: 'Контурный график целевой функции и допустимая область',
        xaxis: {
            title: 'x₁',
            range: [xMin, xMax]
        },
